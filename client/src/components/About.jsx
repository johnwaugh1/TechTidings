const About = () => {
    return (
        <section
            id="about" 
            className="pt-36 px-8 text-center lg:text-left flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-500"
        >
            <div className="max-w-3xl mx-auto mb-48">
                ...
                <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">
                    TechTidings is a platform designed to keep tech enthusiasts, students, and
                ...
                <h3 className="mt-6 text-2xl font-semibold text-gray-900 dark:text-white">My Mission</h3>
                <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">
                ...
                <h3 className="mt-6 text-2xl font-semibold text-gray-900 dark:text-white">How it Started</h3>
                <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">
